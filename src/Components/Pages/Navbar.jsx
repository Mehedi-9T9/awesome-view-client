...
const Navbar = () => {
    ...
    return (
        <div className="navbar sticky top-0 z-10 bg-[#FFFFFF] text-[#003A66] px-[100px] py-4">
            ...
            {
                !user ? <Link to="/login" className='btn bg-[#E02454] text-[#FFF] text-lg'>Login</Link> : <div className="dropdown  dropdown-end ml-10">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar bg-[#E02454]">
